...
public class HeapPage implements Page {
    ...
    private int getNumTuples() {
        ...
        /*
         * Number of bits for the page / number of bits per tuple (tuple size * 8) + 1
         * bit for header
         */
    ...
    private int getHeaderSize() {
        ...
        // Dividing number of tuples by 8 to get number of bytes needed for header
    ...
    public int getNumEmptySlots() {
        // some code goes here (__done__)
        int numBitsForSlots = numSlots * 8;

        int numEmptySlots = 0;
        int totalBitsRead = 0;

        for (int byteCounter = 0; byteCounter < header.length; byteCounter++) {
            for (int bitCounter = 0; bitCounter < 8; bitCounter++) {
                if ((header[byteCounter] & (1 << bitCounter)) == 0 && totalBitsRead <= numBitsForSlots) {
                    numEmptySlots++;
                }
                totalBitsRead++;
            }
    ...
    public boolean isSlotUsed(int i) {
        ...
        return (header[headerByte] & (1 << shiftAmt)) != 0;
    }
