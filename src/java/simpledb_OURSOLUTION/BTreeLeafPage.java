...
public class BTreeLeafPage extends BTreePage {
	...
	/**
	 * Computes the number of bytes in the header of a page in a BTreeFile with each
	...
	/**
	 * Adds the specified tuple to the page such that all records remain in sorted
	 * order;
	...
	/**
	 * @return a reverse iterator over all tuples on this page (calling remove on
